...
print("Mi nombre es %s %s y mi edad es %d" % (name, surname, age)) # en %s es para llenarlo con los parametros que teniamos ademas %s se puede poner cualquier tipo de dato 
print("Mi nombre es " + name + " " + surname + " y mi edad es " + str(age)) # en + espara llenarlo con los parametros que teniamos ademas + se puede poner cualquier tipo de dato
print(f"Mi nombre es {name} {surname} y mi edad es {age}") # en f es para llenarlo con los paraqmetros que teniamos ademas f se puede poner cualquier tipo de dato

#desempacado de caracteres
lenguaje = "python" # esto es un string
a, b, c, d, e, f = lenguaje # esto es un desempacado de catacteres que sirven para ver los caracteres que tiene el string
print(a)
print(e)
