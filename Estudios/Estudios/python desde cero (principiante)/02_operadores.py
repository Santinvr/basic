...
# Operaciones con cadenas de texto
print("Hola" > "Python") # mayor que u orden alfabetico y se muestra si es verdadero o falso
print("Hola" < "Python") # menor que u orden alfabetico y se muestra si es verdadero o falso
...
print("Hola" == "Hola")   # comparacion de cadena de texto
print("Hola" != "Python") # comparacion de cadena de texto
